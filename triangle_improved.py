...
def classify_triangle(side_a, side_b, side_c):
    ...
    return:
        ...
        If the sum of the squares of any two sides equals the square of the third side,
        then return 'Right'
    ...
    if not(isinstance(side_a, (int, float)) and isinstance(side_b, (int, float)) and
        (isinstance(side_c, (int, float)))) or (side_a <= 0 or side_b <= 0 or side_c <= 0):
        return 'InvalidInput'
    ...
    if side_a == side_b == side_c:
        return 'Equilateral'
    if (side_a ** 2 + side_b ** 2 == side_c ** 2) or (side_a**2 + side_c**2 == side_b**2) or (
